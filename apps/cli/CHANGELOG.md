...
- 908ef55: Add `reset` and `reset --to <ref>` for aggressive spotlight cleanup, including stale-session recovery, checkpoint ref sweeping, hard reset, and untracked-file cleanup.
